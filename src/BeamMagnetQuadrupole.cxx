...
//_____________________________________________________________________________
BeamMagnetQuadrupole::BeamMagnetQuadrupole(G4String nam, G4double xpos,G4double ypos,G4double zpos,G4double length, G4double r1, G4double r2, G4double dout, G4double angle, G4double gradient,G4double col1,G4double col2,G4double col3, G4LogicalVolume *top):
